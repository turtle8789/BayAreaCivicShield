...
export default function HomeScreen() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: t('home.desc_translate'),
      iconName: 'globe',
      accentColor: '#C97B8E',
    ...
    },
    {
      ...
      description: t('home.desc_rights'),
      iconName: 'book-open',
      accentColor: '#A07888',
      route: '/(tabs)/rights',
    },
    {
      ...
      description: t('home.desc_resources'),
      iconName: 'map-pin',
      accentColor: '#C9A050',
    ...
    },
    {
      ...
      description: t('home.desc_hotlines'),
      iconName: 'phone-call',
      accentColor: '#E05252',
      route: '/(tabs)/resources',
    },
